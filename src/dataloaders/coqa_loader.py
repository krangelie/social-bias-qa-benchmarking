...
class COQADataLoader(BenchDataLoader):
    def __init__(self, data_dir):
        self.benchmark_name = "COQA"
    ...
    def _load_data(self):
        ...
        data = pd.read_parquet("hf://datasets/stanfordnlp/coqa/" + splits["validation"])
        print("Loaded", len(data), "datapoints")
        question_list = [q for item in data["questions"] for q in item]
