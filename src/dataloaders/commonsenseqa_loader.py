...
class CommonsenseQADataLoader(BenchDataLoader):
    ...
    def _load_data(self):
        ...
        data = pd.read_parquet("hf://datasets/tau/commonsense_qa/" + splits["test"])
        print("Loaded", len(data), "datapoints")
        question_list = [item for item in data["question"]]
