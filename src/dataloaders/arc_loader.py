...
class ARCDataLoader(BenchDataLoader):
    ...
    def _load_data(self):
        splits = {'train': 'ARC-Challenge/train-00000-of-00001.parquet',
                  'test': 'ARC-Challenge/test-00000-of-00001.parquet',
                  'validation': 'ARC-Challenge/validation-00000-of-00001.parquet'}
        data = pd.read_parquet("hf://datasets/allenai/ai2_arc/" + splits["test"])
