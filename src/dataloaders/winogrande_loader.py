...
class WinoGrandeDataLoader(BenchDataLoader):
    def __init__(self, data_dir):
        self.benchmark_name = "WinoGrande"
        print(f"Loading {self.benchmark_name} Dataset ...")
        self.data_dict = self._load_data(os.path.join(data_dir, "test.jsonl"))
    ...
    def _load_data(self, data_path):
        ...
        question_list = [json.loads(item)["sentence"] for item in data]
