...
class QuACDataLoader(BenchDataLoader):
    def __init__(self, data_dir):
        self.benchmark_name = "QuAC"
        self.data_path = data_dir
        print(f"Loading {self.benchmark_name} Dataset ...")
        self.data_dict = self._load_data(os.path.join(data_dir, "val_v0.2.json"))
    ...
    def _load_data(self, data_path):
        ...
        for d in data["data"]:
            question_list += [qa["question"] for p in d["paragraphs"] for qa in p["qas"]]
            title_list += ["title"]
