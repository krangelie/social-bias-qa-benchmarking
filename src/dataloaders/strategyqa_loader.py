...
class StrategyQADataLoader(BenchDataLoader):
    def __init__(self, data_dir):
        self.benchmark_name = "StrategyQA"
        print(f"Loading {self.benchmark_name} Dataset ...")
        self.data_dict = self._load_data(os.path.join(data_dir, "dev.json"))
    ...
    def _load_data(self, data_path):
        ...
        return {"question_list": question_list, "entity_list": term_list}
