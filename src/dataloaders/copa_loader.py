...
class COPADataLoader(BenchDataLoader):
    def __init__(self, data_dir):
        self.benchmark_name = "COPA"
    ...
    def _load_data(self):
        ...
        data = pd.read_csv("hf://datasets/pkavumba/balanced-copa/" + splits["test"])
        print("Loaded", len(data), "datapoints")
        question_list = [item for item in data["premise"]]
