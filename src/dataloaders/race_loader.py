...
class RACEDataLoader(BenchDataLoader):
    def __init__(self, data_dir):
        self.benchmark_name = "RACE"
    ...
    def _load_data(self):
        splits = {'test': 'all/test-00000-of-00001.parquet', 'train': 'all/train-00000-of-00001.parquet',
                  'validation': 'all/validation-00000-of-00001.parquet'}
        data = pd.read_parquet("hf://datasets/ehovy/race/" + splits["test"])
