...
class SIQADataLoader(BenchDataLoader):
    def __init__(self, data_dir):
        self.benchmark_name = "SIQA"
        print(f"Loading {self.benchmark_name} Dataset ...")
        self.data_dict = self._load_data(os.path.join(data_dir, "validation.jsonl"))
    ...
    def _load_data(self, data_path):
        ...
        for item in data:
            ...
            question_w_context = [item_dict["context"] + " " + item_dict["question"]]
            question_list += question_w_context
