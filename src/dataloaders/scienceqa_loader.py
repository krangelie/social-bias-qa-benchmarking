...
class ScienceQADataLoader(BenchDataLoader):
    def __init__(self, data_dir):
        self.benchmark_name = "ScienceQA"
    ...
    def _load_data(self):
        splits = {'train': 'data/train-00000-of-00001-1028f23e353fbe3e.parquet',
                  'validation': 'data/validation-00000-of-00001-6c7328ff6c84284c.parquet',
                  'test': 'data/test-00000-of-00001-f0e719df791966ff.parquet'}
        data = pd.read_parquet("hf://datasets/derek-thomas/ScienceQA/" + splits["test"])
